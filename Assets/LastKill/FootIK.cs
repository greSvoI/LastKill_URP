...
namespace HoaxGames
{
    ...
    public class FootIK : MonoBehaviour
    {
        ...
        protected float m_globalCharacterYOffset = 0.0f;
        ...
        [SerializeField, Tooltip("If enabled the characters shoulders will counteract the spine-bending.")]
        ...
        protected Vector3 m_crouchOffset;
        ...
        protected virtual Vector3 calculatePlanarVelocity(Vector3 feetZeroPos)
        {
            ...
            Vector3 velocity = (feetZeroPos - m_prevTransformPosition) / Time.deltaTime;
        ...
        protected virtual void updateIK(Vector3 feetZeroPos)
        {
            ...
            if (m_globalCharacterYOffset > 0 || m_globalCharacterYOffset < 0)
            {
                ...
                leftHintPos += globalCharOffsetVec;
                rightHintPos += globalCharOffsetVec;
            ...
            Vector3 ikLeftMovementDirection = ikLeft - m_prevIkLeft;
            Vector3 ikRightMovementDirection = ikRight - m_prevIkRight;
            ...
            Vector3 transformMovementVec = m_transform.position - m_prevTransformPosition;
            ...
            if (ikLeftMovementDistance > m_minimumMovementThreshold)
            {
                m_prevIkLeft = ikLeft;
            ...
            if (ikRightMovementDistance > m_minimumMovementThreshold)
            {
            ...
            m_bodyOffset = Vector3.Lerp(m_bodyOffset, m_rawbodyOffsetVec, Time.deltaTime * m_bodyStiffness);
            ...
            {
                Vector3 changeInBodyPosition = m_animator.bodyPosition - m_prevBodyPosition;
        ...
        protected Vector3 calculateHintPos(Vector3 bodyPos, Vector3 nextIkPos, float lowerLength, float upperLength, Vector3 ikPosToBodyPosOriginalVec, Vector3 hintDirectionVec)
        {
            ...
            if (c > (a + b) * 0.95f) c = (a + b) * 0.95f; // to avoid isNan
        ...
        protected virtual void updateEvents(IKResult resultLeft, Vector3 ikLeftTargetPos, IKResult resultRight, Vector3 ikRightTargetPos, Vector3 transformMovementPlanarVec)
        {
            ...
            Vector3 movedLeftVec = resultLeft.surfacePoint - m_lastFootstepPosLeft;
            Vector3 movedRightVec = resultRight.surfacePoint - m_lastFootstepPosRight;
        ...
        protected virtual GroundedResult isValidAndGrounded(Vector3 feetZeroPos, Vector3 upVec, int collisionLayer)
        {
            ...
            {
                Vector3 distVec = Vector3.Project(feetZeroPos - m_prevTransformPosition, upVec);
